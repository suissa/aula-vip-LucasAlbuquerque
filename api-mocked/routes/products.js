...
router.get('/:page?', (req, res, next) => {
  ...
  console.log(page);
  console.log('------------------------------------');
  return res.json(getProducts(page))
})
...
// const getProducts = (page) => Array(QNTD_PRODUCTS).fill(0).map(getRandomProduct).slice(getBeginPage(page), getEndPage(page))
